...
It is designed to check for APs connected to the WLC and ensure they are claimed in your Meraki Organization and assigned to a specific Network (e.g., for verification/licensing compliance).
